import { BoundingBox, Coordinates, Geocoding } from './Geocoding'

describe('areCoordinatesInBoundingBox', () => {
    it('Check if London is in UK', () => {
    ...
    it('Check if Berlin is in Germany', () => {
    ...
    it('Check if Sydney is in Australia', () => {
    ...
    it('Check if Moscow is in the US', () => {
...
describe('areCoordinatesBetweenTwoPoints', () => {
    ...
    it('Check that New York is not in UK', () => {
        const location: Coordinates = { latitude: 40.7128, longitude: 74.006 } //New york
    ...
    it('Check if point at PMI is not at KLQ with buffer', () => {
        const location: Coordinates = { latitude: 39.543, longitude: 2.727 } //PMI
        const northeast: Coordinates = {
            latitude: 5.656636,
            longitude: 106.096839,
        } //KLQ
        const southwest: Coordinates = {
            latitude: -5.943322,
            longitude: 95.193437,
    ...
    it('Check if point at PMI is at PMI with no buffer (middle)', () => {
    ...
    it('Check if point at PMI is at PMI with buffer (north east)', () => {
    ...
    it('Check if point at PMI is at PMI with buffer (north west)', () => {
    ...
    it('Check if point at PMI is at PMI with buffer (south west)', () => {
    ...
    it('Check if point at PMI is at PMI with buffer (south east)', () => {
    ...
    it('Airport should not find with 0k buffer', () => {
    ...
    it('Airport should not find with 0.5k buffer', () => {
        const location: Coordinates = { latitude: 52.310284, longitude: 4.753804 }
        const northeast: Coordinates = { latitude: 52.311888, longitude: 4.769623 } //AMS
        const southwest: Coordinates = { latitude: 52.30919, longitude: 4.766925 } //AMS
    ...
    it('Airport find with 5k buffer', () => {
        const location: Coordinates = { latitude: 52.310284, longitude: 4.753804 }
        const northeast: Coordinates = { latitude: 52.311888, longitude: 4.769623 } //AMS
        const southwest: Coordinates = { latitude: 52.30919, longitude: 4.766925 } //AMS
        expect(Geocoding.areCoordinatesBetweenTwoPoints(location, northeast, southwest, 5000)).toBeTruthy()
    ...
    it('Airport find with 10k buffer', () => {
        const location: Coordinates = { latitude: 52.310284, longitude: 4.753804 }
        const northeast: Coordinates = { latitude: 52.311888, longitude: 4.769623 } //AMS
        const southwest: Coordinates = { latitude: 52.30919, longitude: 4.766925 } //AMS
    ...
    it('Check that MMY airpot is not inside IRD airport with 75km buffer ', () => {
    ...
    it('Check that HTG airpot is not inside YSY airport with 75km buffer ', () => {
        const location: Coordinates = {
            latitude: 71.977295,
            longitude: 102.486549,
        } //HTG
        const northeast: Coordinates = {
            latitude: 71.993075,
            longitude: -125.242175,
        } //YSY
        const southwest: Coordinates = {
            latitude: 71.993079,
            longitude: -125.242185,
        } //YSY
        expect(Geocoding.areCoordinatesBetweenTwoPoints(location, northeast, southwest, 75000)).toBeFalsy()
    })

    it('Truthy buffer test 1: Check that point is inside bounding box with 50km buffer', () => {
    ...
    it('Truthy buffer test 2: Check that point is inside bounding box with 25km buffer', () => {
    ...
    it('Truthy buffer test 3: Check that point is inside bounding box with 10km buffer', () => {
    ...
    it('Truthy buffer test 4: Check that point is inside bounding box with 30km buffer', () => {
    ...
    it('Truthy buffer test 5: Check that point is inside bounding box with 5km buffer', () => {
    ...
    it('Truthy buffer test 6: Check that point is just inside bounding box with 1km buffer', () => {
    ...
    it('Truthy buffer test 7: Check that point is just inside bounding box with 500m buffer', () => {
    ...
    it('Falsey buffer test 1: Check that point is outside bounding box even with 50km buffer', () => {
    ...
    it('Falsey buffer test 2: Check that point is outside bounding box even with 25km buffer', () => {
    ...
    it('Falsey buffer test 3: Check that point is outside bounding box even with 10km buffer', () => {
    ...
    it('Falsey buffer test 4: Check that point is outside bounding box even with 100km buffer', () => {
    ...
    it('Falsey buffer test 5: Check that point is outside bounding box even with 75km buffer', () => {
    ...
    it('Falsey buffer test 6: Check that point is outside bounding box even with 1km buffer', () => {
    ...
    it('Falsey buffer test 7: Check that point is outside bounding box even with 200m buffer', () => {
    ...
    it('Falsey buffer test 8: Check that point is outside bounding box even with 100m buffer', () => {
